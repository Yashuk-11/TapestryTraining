...
@Configuration
@ComponentScan({ "org.apache.tapestry.Sampleproject" })
    ...
    public ServletContextInitializer initializer() {
        return new ServletContextInitializer() {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "org.apache.tapestry.Sampleproject");
                servletContext.setInitParameter("tapestry.development-modules", "org.apache.tapestry.Sampleproject.services.DevelopmentModule");
